AirBnBclone is a full static website. here I created the interpreter and relevant classes for the backend with a storage system AirBnBclone is still in active development, with complete functionality set to deploy in the coming month:
